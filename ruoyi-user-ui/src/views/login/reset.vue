...
const currentTheme = ref(6); // 星空紫主题
        ...
        <div class="form-wrapper">
          <NCard class="login-card" :bordered="false">
            <div class="card-header">
              ...
              <p class="welcome-subtitle">找回您的账户访问权限</p>
            </div>
            ...
            <div class="form-content">
                ...
                <div class="verification-code-row">
                  <div class="input-wrapper">
                    <NInput 
                      ...
                      :placeholder="$t('reset.enter_verification_code')" 
                      round
                      class="verification-input" 
                      :status="formErrors.code ? 'error' : undefined"
                      size="large"
                    >
                      <template #prefix>
              ...
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  <NInput 
                    ...
                    :placeholder="$t('reset.enter_new_password')" 
                    round
                    class="custom-input" 
              ...
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  <NInput 
                    ...
                    :placeholder="$t('reset.enter_confirm_password')" 
                    round
                    class="custom-input" 
                    :status="formErrors.confirmPassword ? 'error' : undefined"
                    size="large"
                  >
                    <template #prefix>
                      <NIcon :component="LockClosedOutline" class="input-icon" />
              ...
              <div class="register-prompt">
                <span>{{ $t("reset.reset_ok") }}</span>
                <NButton text type="primary" @click="router.push('/login')" class="register-link">
                  {{ $t("reset.login") }}
                </NButton>
              </div>
            </div>
